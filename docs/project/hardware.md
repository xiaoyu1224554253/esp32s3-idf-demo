...
- 屏幕物理分辨率为 **240 × 320 竖屏**，本项目采用 **横屏 320 × 240** 使用方式：
  - ILI9341 驱动支持软件旋转（`MADCTL` 寄存器设置 0x28 或 0xE8）
  - LVGL 中设置 `LV_DISP_ROT_90` 或驱动层完成旋转
  - FT6336G 触摸坐标需要同步做 90° 旋转映射
